...
docker pull drozdovsa/new-api-gateway:latest
docker pull drozdovsa/new-product-service:latest
docker pull drozdovsa/new-order-service:latest
docker pull drozdovsa/new-inventory-service:latest
docker pull drozdovsa/new-notification-service:latest
...
kind load docker-image -n microservices drozdovsa/new-api-gateway:latest
kind load docker-image -n microservices drozdovsa/new-product-service:latest
kind load docker-image -n microservices drozdovsa/new-order-service:latest
kind load docker-image -n microservices drozdovsa/new-inventory-service:latest
kind load docker-image -n microservices drozdovsa/new-notification-service:latest
